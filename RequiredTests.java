...
public class RequiredTests {
    ...
    public void testInsureVehicle() {
        ...
        SingleVehicleContract c1;
        c1 = insuranceCompany.insureVehicle("number", null, naturalPerson1, 150, PremiumPaymentFrequency.SEMI_ANNUAL, vehicle1);
    ...
    public void testPayMasterContractSimple() {
        SingleVehicleContract c1;
        c1 = insuranceCompany.insureVehicle("c1", null, legalPerson1, 1500, PremiumPaymentFrequency.ANNUAL,     new Vehicle("AA111AA", 15_000));
        SingleVehicleContract c2;
        c2 = insuranceCompany.insureVehicle("c2", null, legalPerson1, 184, PremiumPaymentFrequency.MONTHLY,     new Vehicle("BANAN22", 22_000));
